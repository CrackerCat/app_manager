...
//     details.activitys = await appChannel.getAppActivitys(widget.entity.package);
//     String result = await appChannel.getAppDetails(widget.entity.package);
...
//     details.apkSize = await getFileSize(widget.entity.sourceDir);
//     Log.w('apkSize -> ${details.apkSize}}');
//     String md5 = await Global().exec('md5sum ${widget.entity.sourceDir}');
//     md5 = md5.replaceAll(RegExp(' .*'), '');
//     String sha1 = await Global().exec('sha1sum ${widget.entity.sourceDir}');
//     sha1 = sha1.replaceAll(RegExp(' .*'), '');
//     String sha256 = await Global().exec('sha256sum ${widget.entity.sourceDir}');
//     sha256 = sha256.replaceAll(RegExp(' .*'), '');
//     details.apkMd5 = md5;
//     details.apkSha1 = sha1;
//     details.apkSha256 = sha256;
//     // widget.entity.details = details;
//     List<String> pers = await appChannel.getAppPermission(widget.entity.package);
//     Log.w('pers -> $pers');
...
//                                   // }
//                                   AppManagerController controller = Get.find();
//                                   String activity = await controller.curChannel!.getAppMainActivity(entity.package);
//                                   controller.curChannel!.openApp(entity.package, activity, id);
...
//                                 Global().appChannel!.clearAppData(entity.package);
//                               }),
//                               buildItem('卸载', danger: true, onTap: () async {
//                                 await Global().appChannel!.unInstallApp(entity.package);
...
//                                     await Global().appChannel!.unFreezeApp(entity.package);
//                                     entity.enabled = true;
//                                     setState(() {});
//                                     AppManagerController controller = Get.find();
//                                     controller.update();
...
//                                     bool success = await Global().appChannel!.showApp(entity.package);
//                                     if (success) {
//                                       entity.hide = false;
//                                       setState(() {});
//                                       AppManagerController controller = Get.find();
...
//                                   bool success = await Global().appChannel!.hideApp(entity.package);
//                                   if (success) {
//                                     entity.hide = true;
//                                     setState(() {});
//                                     AppManagerController controller = Get.find();
...
//                                 Get.back();
//                                 PluginUtils.shareFile(widget.entity.sourceDir);
//                               }),
//                             ],
//                           ),
//                         ),
...
//                                                 child: AppIconHeader(
//                                                   padding: EdgeInsets.zero,
//                                                   packageName: widget.entity!.package,
//                                                 ),
//                                               ),
//                                               SizedBox(
//                                                 width: 4,
